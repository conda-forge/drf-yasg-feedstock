...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/drf-yasg-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10395&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/drf-yasg-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `drf-yasg` can be installed with:

```
conda install drf-yasg
```

It is possible to list all of the versions of `drf-yasg` available on your platform with:
